...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    std::cout << "Intersection #" << _id << ": Vehicle #" << vehicle->getID() << " is waiting for greenlight." << std::endl;
    lck.unlock();

    auto futureGreenLight = std::async(&TrafficLight::waitForGreen, &_trafficLight);
  	futureGreenLight.get();
  	lck.lock();
    std::cout << "Intersection #" << _id << ": Vehicle #" << vehicle->getID() << " is safe to proceed!" << std::endl;
    lck.unlock();
}
